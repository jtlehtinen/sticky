...
public class EntryPoint {
  ...
  private static bool DecideRedirection() {
    ...
    try {
      AppInstance keyInstance = AppInstance.FindOrRegisterForKey("6eb058a6-55d4-46b3-a572-814ab612926c");
  ...
  private static void OnActivated(object sender, AppActivationArguments args) {
    ...
    // @TODO: Show and activate (bring to foreground) the main window
  }
