...
namespace ModernWpf.Controls {
  ...
  public class XamlControlsResources : ResourceDictionary {
    ...
    //internal static ResourceDictionary XamlControlResources
    //{
    //    get
    //    {
    //        if (_xamlResources == null)
    //        {
    //            _xamlResources = new ResourceDictionary { Source = new Uri("pack://application:,,,/ModernWpf.Controls;component/XamlControlsResources.xaml") };
    //        }
    //        return _xamlResources;
    //    }
    //}
    ...
    private static ResourceDictionary _xamlResources;
